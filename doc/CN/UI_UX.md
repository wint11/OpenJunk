...
### 5. 公开评审与内容更新（`/public-review`）
*   **公开评审平台**: 以公开可访问的方式展示内容，并提供受控的信息更新入口（如标题/摘要/作者等）。
*   **审核与权限**: 更新流程通常与登录态/权限绑定，避免匿名篡改。

### 6. 智能排版与编辑（`/discovery/typesetting`）
*   **编辑器**: 面向排版与模板化输出的编辑能力入口。
*   **结果呈现**: 提供可视化编辑与预览，降低模板/样式调参成本。

### 7. 宇宙视图（`/universe`）
*   **3D 场景**: 作为互动入口的可视化模块。
*   **答题系统**: 通过答题与战力/赛季等机制增加趣味性与留存。
